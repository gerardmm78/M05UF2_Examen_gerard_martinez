...
public class AvaluadorTestPar2 {
    ...
    public AvaluadorTestPar2(Estudiant estudiant, double resultat) {
    ...
    public void testMitjana() throws Exception {
        assertEquals(resultat, instance.mitjana(estudiant), 1.0E-3);
    }
